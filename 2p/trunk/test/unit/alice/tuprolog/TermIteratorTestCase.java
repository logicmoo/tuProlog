...
public class TermIteratorTestCase extends TestCase {
	...
	public void testMultipleNext() {
		...
		assertEquals(TuStruct.createTuStruct1("q", TuTerm.i32(1)), i.next());
		assertEquals(TuStruct.createTuStruct1("q", TuTerm.i32(2)), i.next());
		assertEquals(TuStruct.createTuStruct1("q", TuTerm.i32(3)), i.next());
		assertEquals(TuStruct.createTuStruct1("q", TuTerm.i32(5)), i.next());
		assertEquals(TuStruct.createTuStruct1("q", TuTerm.i32(7)), i.next());
		// no more terms
		assertFalse(i.hasNext());
		try {
			i.next();
	...
	public void testIterationOnInvalidTheory() {
		String theory = "q(1)." + "\n" +
						...
						"q(5)." + "\n" +
						"q(7).";
		TuStruct firstTerm = TuStruct.createTuStruct1("q", TuTerm.i32(1));
		TuStruct secondTerm = TuStruct.createTuStruct1("q", TuTerm.i32(2));
