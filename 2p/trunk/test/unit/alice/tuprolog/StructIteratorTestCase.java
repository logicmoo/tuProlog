...
public class StructIteratorTestCase extends TestCase {
    ...
    public void testIteratorCount() {
        TuStruct list = createTuListStruct(new Term[] { createTuInt(1), createTuInt(2), createTuInt(3), createTuInt(5),
                createTuInt(7) });
        Iterator<? extends Term> i = list.listIterator();
        int count = 0;
        for (; i.hasNext(); count++)
    ...
    public void testMultipleHasNext() {
        TuStruct list = createTuListStruct(new Term[] { createTuAtom("p"),
    ...
    public void testMultipleNext() {
        TuStruct list = createTuListStruct(new Term[] { createTuInt(0), createTuInt(1), createTuInt(2), createTuInt(3),
