...
public class TuClauseDatabase extends HashMap<String,FamilyClausesList> implements Iterable<ClauseInfo> {
	...
	private static class CompleteIterator implements Iterator<ClauseInfo> {
		...
		public CompleteIterator(TuClauseDatabase clauseDatabase) {
