 ...
 */
class TuFlag implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	protected Term   value;
    private String name;
    private TuStruct valueList;
     ...
     */
    public TuFlag(String name, TuStruct valueSet, Term defValue, boolean modifiable, String library) {
	...
	public Object clone() {
        TuFlag f = new TuFlag();
        f.name=name;
        f.valueList=(TuStruct)valueList.copy(TuVar.ORIGINAL,new HashMap<TuVar,TuVar>());
        f.value=value.copy(TuVar.ORIGINAL,new HashMap<TuVar,TuVar>());
        f.defaultValue=defaultValue.copy(TuVar.ORIGINAL,new HashMap<TuVar,TuVar>());
