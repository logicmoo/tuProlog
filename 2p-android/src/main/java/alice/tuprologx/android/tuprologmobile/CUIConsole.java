...
public class CUIConsole extends Automaton implements Serializable,
    ...
    private alice.tuprologx.android.tuprologmobile.tuPrologActivity tup;
    ...
    public CUIConsole(TextView tv, final EditText title, AutoCompleteTextView et, Button btn,
                      TextView sol, TextView out, Button next, Toast t, tuPrologActivity tuP, Button clear) {
        engine = new Prolog();
        ...
        mHDbHelper = new QueriesHistoryDbAdapter(tuPrologActivity.getContext());
        mHDbHelper.open();
        prefs = tuPrologActivity.getContext().getSharedPreferences(MY_PREFERENCES, Context.MODE_PRIVATE);
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editText.getText().toString().equals("") || title.getText().toString().equals("")) {
                    toast.show();
                } else {
                    ...
                    if (prefs.getBoolean("swSaveQ", false) == true)
                        mHDbHelper.createQuery(titleText.getText().toString(), editText.getText().toString());
...
//        }
    ...
    public static void main(TextView tv, EditText title, AutoCompleteTextView et, Button btn,
                            TextView sol, TextView out, Button next, Toast t, tuPrologActivity tuP, Button clear) {

       new Thread(new CUIConsole(tv, title, et, btn, sol, out, next, t, tuP, clear)).start();

    }

    public static void main2() {

        new Thread(new CUIConsole()).start();
