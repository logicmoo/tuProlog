 ...
 */
public class TheoryHistoryDbAdapter {
    ...
    public TheoryHistoryDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }

    public TheoryHistoryDbAdapter open() throws SQLException {
    ...
    public Cursor searchTheory(String titleSearch) throws  SQLException {
