...
public class PrologNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		addBuilder(PrologParser.BUILDER_ID);
	//	addBuilder(PrologBuilder.BUILDER_ID);
	}
	...
	public void deconfigure() throws CoreException {
		removeBuilder(PrologParser.BUILDER_ID);
		//removeBuilder(PrologBuilder.BUILDER_ID);
	}
