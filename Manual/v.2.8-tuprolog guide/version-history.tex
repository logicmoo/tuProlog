...
\begin{itemize}
  ...
  \item Support for keyboard input in IOLibrary/ISOIOLibrary also on the GUIConsole and Android app in 2.8: Mirco Mastrovito (2013)
  \item Extensive bug fix in the engine state machine, including assert/retract handling in 2.8: Roberta Calegari (2013)
\end{itemize}
