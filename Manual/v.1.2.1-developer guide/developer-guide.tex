...
%\include{developerGuideInstallation}
\include{using-tuprolog-from-java/using-tuprolog-from-java}
\include{java-library/java-library}
\include{howto-develop-libraries/howto-develop-libraries}
%\include{developerGuideAppendix}
