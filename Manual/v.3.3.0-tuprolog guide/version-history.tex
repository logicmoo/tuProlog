...
\begin{table}[h]
 ...
 \hspace*{-1cm}\begin{tabular}{|p{1.2cm}|p{1.2cm}|p{1.7cm}|p{1.4cm}|p{7.3cm}|}
   ...
   3.3.0       & Swing & 217K & 7,1M & new eclipse plugin; new android application\\
   \hline
 \end{tabular}
...
Released on September 2018, this version aims to provide a stable environment for the new eclipse plugin and the new android application. 
...
\begin{itemize}
  ...
  \item New Android application: Lucrezia Paradisi (2018)
  \item New Eclipse plug-in: Riccardo Vasumini (2018)
\end{itemize}
