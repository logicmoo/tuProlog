...
\begin{table}[h]
 ...
 \hspace*{-1cm}\begin{tabular}{|p{1.2cm}|p{1.2cm}|p{1.7cm}|p{1.4cm}|p{7.3cm}|}
   ...
   3.2         & Swing & 213K & 7,1M & JSON support for engine's state serialization\\
   \hline
 \end{tabular}
...
\section{Version 3.2}
Released on January 2017, this version aims to provide JSON API for the serialization/deserialization of the prolog engine state. 
...
\begin{itemize}
  ...
  \item \texttt{JSON} support for engine's state serialization in 3.2: Alberto Sita (2016 - early 2017)
\end{itemize}
