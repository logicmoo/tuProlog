...
\begin{sidewaystable}
	...
	\centering
			...
			%\begin{tabular}{p{4.8cm}|p{2.2cm}|p{2.2cm}|p{1.8cm} | p{4.8cm}}\hline\hline
				...
				occurCheck & {on, off}          &  on        & yes  & Built-in\\
...
\begin{table}[h]
 ...
 \hspace*{-1cm}\begin{tabular}{|p{1.2cm}|p{1.2cm}|p{1.7cm}|p{1.4cm}|p{7.3cm}|}
   ...
   3.2         & Swing & 213K & 7,1M & JSON support for engine's state serialization and occur check management via prolog flag\\
   \hline
 \end{tabular}
...
\section{Version 3.2}
Released on January 2017, this version aims to provide JSON API for the serialization/deserialization of the prolog engine state. This version also introduces the possibility to manage occur check functionality via prolog flag.
...
\begin{itemize}
  ...
  \item \texttt{JSON} support for engine's state serialization and occur check management via prolog flag in 3.2: Alberto Sita (2016 - early 2017)
\end{itemize}
