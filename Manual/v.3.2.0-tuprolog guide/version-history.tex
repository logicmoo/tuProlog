...
\begin{table}[h]
 ...
 \hspace*{-1cm}\begin{tabular}{|p{1.2cm}|p{1.2cm}|p{1.7cm}|p{1.4cm}|p{7.3cm}|}
   ...
   3.2         & Swing & 207K & 7M & JSON support for engine's state serialization\\
   \hline
 \end{tabular}
...
\section{Version 3.2}
Released on January 2017, this version aims to provide JSON API for the serialization/de-serialization of the prolog engine state. 
