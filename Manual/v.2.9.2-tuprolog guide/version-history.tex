...
\begin{table}[h]
 ...
 \begin{tabular}{|p{1.5cm}|p{1cm}|p{1cm}|p{1.5cm}|p{1.5cm}|p{6cm}|}
   ...
   2.7.2       & Swing & yes & -- & 504K (+600K javassist) & many bug fixes, new SpyFrame \\% and query tree view\\
   2.8         & Swing & yes & -- & 537K (+600K javassist) & classpath issues, many bugfixes, first keyboard input support in GUI\\
   2.9         & Swing & yes & -- & 537K (+600K javassist) & setof/bagof bug fixes, better class loading in Android, keyboard input support via input tab, extensive ISO-compliance testing\\
   2.9.2       & Swing & yes & -- & 537K (+600K javassist) & further bug fixes, new editor in Java/.NET GUI, Visual Studio code generators for P@.NET now compatible with Visual Studio 2012/13, and new acceptance test suite based on the Concordion framework instead of the old-fashioned FIT framework\\
   \hline
 \end{tabular}
...
\subsection{From Version 2.7.2 to Version 2.8}
...
\subsection{From Version 2.8 to Version 2.9}
...
\subsection{From Version 2.9 to Version 2.9.2}
