...
public class FilePropertyField extends PropertyField implements ActionListener, KeyListener {
	...
	public FilePropertyField(PropertyFile propertyFile, String propertyName, boolean directory) {
